            ...
            <div className="subpage">
                ...
                <div className="right">
                    <div className="info">
                        ...
                        <h4>Info</h4>
                        <p>
                            Ipé er en af de mest ekslusive træsorter med en
                            fantastisk slidstyrke og holdbarhed. Ipé-brædder har
                            en bred vifte af mørkebrune farver
                        </p>
                        ...
                        <h4>Densitet</h4>
                        <p>
                            1000 kg/m<sup>3</sup> ved 12 % træfugtighed
                        </p>
                    </div>
                </div>
            </div>
