            ...
            <div className="subpage">
                ...
                <div className="right">
                    <div className="info">
                        ...
                        <h4>Info</h4>
                        <p>
                            Mandioquiera er en brasiliansk træsort. Træet har en
                            spændende farve bestående af rød- og lysebrune
                            nuancer. Ikke to Mandioquiera-brææder er ens.
                        </p>
                        ...
                        <h4>Densitet</h4>
                        <p>
                            740 kg/m<sup>3</sup> ved 12 % træfugtighed
                        </p>
                    </div>
                </div>
            </div>
