    ...
    return (
        <Layout title="Kompositterrasse">
            ...
            <div className="subpage">
                ...
                <div className="right">
                    <div className="info">
                        <h2>Heimdal Eg | Hårdttræ</h2>
                        <h4>Info</h4>
                        <p>
                            Heimdal Eg | Hårdttræ er en smuk, moderne og
                            naturtro terrasebrædde fra Kirkedal. Brættet er
                            langtidsholdbart og slidstærkt og med en
                            UV-beskyttet overflade
                        </p>
